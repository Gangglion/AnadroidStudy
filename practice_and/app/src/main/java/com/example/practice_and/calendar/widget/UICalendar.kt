package com.example.practice_and.calendar.widget
...
import com.example.practice_and.calendar.data.Day
import com.example.practice_and.calendar.view.ExpandIconView
import com.example.practice_and.calendar.view.LockScrollView
import com.example.practice_and.calendar.view.OnSwipeTouchListener
...
abstract class UICalendar constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) : ScrollView(context, attrs, defStyleAttr) {
    ...
    protected fun setAttributes(attrs: TypedArray) {
        ...
        val selectedItemBackgroundDrawable = attrs.getDrawable(R.styleable.UICalendar_selectedItem_background)
